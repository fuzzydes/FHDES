...
def initialize_ds(pool_classifiers, uncalibratedpool, X_DSEL, y_DSEL, k=7):
    ...
    list_ds = [majority_voting, single_best, oracle,knorau,kne,desknn,ola,mcb,rank,knop,meta,desfh_w,desfh_m]
    methods_names = ['MV', 'SB', 'Oracle', 'KNORA-U', 'KNORA-E', 'DESKNN', 'OLA', 'MCB', 'RANK', 'KNOP', 'META-DES', 'FH-DES-C', 'FH-DES-M' ]
...
datasets = {
#new datasets:
"Steel",  "Car", "Statlog", "Datausermodeling", "Banknote", "Transfusion", "Voice3", "Voice9", "Vertebral", "Wholesale"
